...
Implement module hub + internal tabs and first practical flows.
...
Implement hub + tabs with builder and advisor separation.
...
### 2.3 Garage
Implement hub + tabs with clear state and action pathways.
...
5. Apply the shared template to the three priority modules first.
   - Capital Core, Iron Temple, and Garage get real hubs + internal tabs.
